...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
    ...
    modifier checkValue(uint _upc) {
        ...
        (bool success, ) = payable(items[_upc].distributorID).call{value: amountToReturn}("");
    ...
    function buyItem(uint _upc) public payable 
        ...
        (bool success, ) = payable(items[_upc].originFarmerID).call{value: items[_upc].productPrice}("");
